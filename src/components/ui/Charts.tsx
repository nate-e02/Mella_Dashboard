  ...
  return (
    <ResponsiveContainer width="100%" height={220}>
      <AreaChart data={data} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
        ...
        <Tooltip contentStyle={tooltipStyle} labelStyle={{ color: "#e7e9ee" }} formatter={(value) => [formatCurrency(Number(value), currency), t("common.chart.revenue")]} />
  ...
  return (
    <ResponsiveContainer width="100%" height={260}>
      <AreaChart data={data} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
        ...
        <Tooltip contentStyle={tooltipStyle} labelStyle={{ color: "#e7e9ee" }} formatter={(value) => [formatCurrency(Number(value), currency), t("common.chart.equity")]} />
